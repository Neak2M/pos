...
import { Settings, Globe, Bell, Shield, Database, Smartphone } from "lucide-react"
...
export function SystemPreferences() {
  ...
  const handleSave = async () => {
    ...
    toast({
      ...
      description: "Your system preferences have been successfully updated.",
    })
  }
    ...
    <div className="grid gap-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="storeName" placeholder="Enter store name" defaultValue="My Retail Store" />
            </div>
            <div className="space-y-2">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Notify when inventory levels are low</p>
            </div>
            <Switch defaultChecked />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="stockThreshold" type="number" placeholder="10" defaultValue="10" />
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="sessionTimeout" type="number" placeholder="30" defaultValue="30" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="passwordLength">Minimum Password Length</Label>
              <Input id="passwordLength" type="number" placeholder="8" defaultValue="8" />
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure data management and backup settings.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
          ...
          <div className="space-y-2">
            ...
            <Input id="backupRetention" type="number" placeholder="30" defaultValue="30" />
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure mobile application features and access.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>Mobile Access</Label>
              <p className="text-sm text-muted-foreground">Allow access via mobile applications</p>
            </div>
            <Switch defaultChecked />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Enable offline functionality for mobile apps</p>
            </div>
            <Switch />
          </div>
